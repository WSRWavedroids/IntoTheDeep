...
public class SparkFunDrive extends MecanumDrive {
    ...
    public static class Params {
        ...
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-0.75, 0, Math.toRadians(0));
        ...
        public double linearScalar = 1.039904427;
        public double angularScalar = 0.9918584088;
    }
    ...
    public SparkFunDrive(HardwareMap hardwareMap, Pose2d pose) {
        super(hardwareMap, pose);
        FlightRecorder.write("OTOS_PARAMS",PARAMS);
        otos = hardwareMap.get(SparkFunOTOS.class,"sparkFunSparkJoy");
        // RR localizer note:
